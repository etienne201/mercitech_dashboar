<template>
  <div class="flex items-center justify-center py-8 px-2">
    <div class="w-full sm:px-6">
            <div class="flex flex-col lg:flex-row p-4 lg:p-8 justify-between items-start 
            lg:items-stretch w-full">
                <div class="w-full lg:w-1/3 flex flex-col lg:flex-row items-start lg:items-center">
                    <div class="flex items-center">
                        <a class="text-gray-600 dark:text-gray-400 p-2 border-transparent border
                         bg-gray-100 dark:hover:bg-gray-600 dark:bg-gray-700 hover:bg-gray-200
                          cursor-pointer rounded focus:outline-none focus:border-gray-800 
                          focus:shadow-outline-gray" href="javascript: void(0)">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon cursor-pointer 
                            icon-tabler icon-tabler-edit" width="20" height="20" viewBox="0 0 24 24"
                        ...
                        <a class="text-gray-600 dark:text-gray-400 mx-2 p-2 border-transparent
                         border bg-gray-100 dark:hover:bg-gray-600 dark:bg-gray-700 hover:bg-gray-200 
                         cursor-pointer rounded focus:outline-none focus:border-gray-800 
                         focus:shadow-outline-gray" href="javascript: void(0)">
                                ...
                                <path d="M10.325 4.317c.426-1.756 2.924-1.756 3.35
                                 0a1.724 1.724 0 0 0 2.573 1.066c1.543-.94 3.31.826 2.37
                                  2.37a1.724 1.724 0 0 0 1.065 2.572c1.756.426 1.756 2.924
                                   0 3.35a1.724 1.724 0 0 0 -1.066 2.573c.94 1.543-.826 3.31-2.37 
                                   2.37a1.724 1.724 0 0 0 -2.572 1.065c-.426 1.756-2.924 1.756-3.35 
                                   0a1.724 1.724 0 0 0 -2.573 -1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 
                                   1.724 0 0 0 -1.065 -2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 0 
                                   0 1.066 -2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" />
                                <circle cx="12" cy="12" r="3" />
                            </svg>
                        </a>
                        <a class="text-gray-600 dark:text-gray-400 mr-2 p-2 border-transparent border
                         bg-gray-100 dark:hover:bg-gray-600 dark:bg-gray-700 hover:bg-gray-200 cursor-pointer rounded focus:outline-none focus:border-gray-800 focus:shadow-outline-gray" href="javascript: void(0)">
                        ...
                        <a class="text-red-500 p-2 border-transparent border
                         bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 
                         hover:bg-gray-200 cursor-pointer rounded focus:outline-none
                          focus:border-gray-800 focus:shadow-outline-gray" href="javascript: void(0)">
                            <svg xmlns="http://www.w3.org/2000/svg" 
                ...
                <div class="w-full lg:w-2/3 flex flex-col lg:flex-row items-start lg:items-center justify-end">
                    ...
                    <div class="lg:ml-6 flex items-center">
                        <div class="text-white ml-4 cursor-pointer focus:outline-none border border-transparent focus:border-gray-800 focus:shadow-outline-gray
                         bg-indigo-600 transition duration-150 ease-in-out hover:bg-indigo-200 w-15 h-15 rounded flex items-center justify-center">
                            ...
                            </svg>  <router-link to="/admin/dashboard/Add-products" class="text-gray-100 h-15 w-15">Add</router-link> 
        ...
        <table class="w-full whitespace-nowrap">
          <thead>
            ...
            >
              ...
              <th class="font-normal text-left pl-4">Invoice Number</th> 
              <th class="font-normal text-left pl-12">Client</th>
              <th class="font-normal text-left pl-12">Company Contact</th>
              <th class="font-normal text-left pl-20">Amount</th>
              <th class="font-normal text-left pl-20">Date</th>
              <th class="font-normal text-left pl-5 ">Mores</th>
            </tr>
          </thead>
          <tbody class="w-full">
            <tr
            ...
            <td class="text-sm pr-6 whitespace-no-wrap text-gray-800 dark:text-gray-100 tracking-normal
             leading-4">Toyota Motors</td>
                  <td class="pl-6 whitespace-no-wrap">
                   <div class="flex items-center">
                     <div class="h-8 w-8">
         ...
         <div class="w-2 h-2 rounded-full bg-indigo-800"></div>
              ...
              <td class="px-7 2xl:px-0">
                <button
                  ...
                  class="focus:ring-2 rounded-md focus:outline-none ml-3"
                  role="button"
                  aria-label="options"
                >
                  <svg
                ...
                >
                  <div
                    ...
                    "
                  >
                    <router-link to="/admin/dashboard/Edit-products" class="text-gray-600 ">Edit</router-link> 
                  </div>
                  <div
                    tabindex="0"
                    class="
 ...
 <td class="text-sm pr-6 whitespace-no-wrap text-gray-800 dark:text-gray-100 tracking-normal leading-4">Toyota Motors</td>
            ...
            >
                            ...
                            <td class="text-sm pr-6 whitespace-no-wrap text-gray-800 dark:text-gray-100 tracking-normal leading-4">#MC10023</td>
 <td class="text-sm pr-6 whitespace-no-wrap text-gray-800 dark:text-gray-100 tracking-normal leading-4">Toyota Motors</td>       <td class="pl-6 whitespace-no-wrap">
                                <div class="flex items-center">
                                    <div class="h-8 w-8">
                                        <img src="https://tuk-cdn.s3.amazonaws.com/assets/components/advance_tables/at_1.png" alt="" class="h-full w-full rounded-full overflow-hidden shadow" />
                                    </div>
              ...
              <td class="pl-16">
                <div class="flex items-center">
       <div class="w-2 h-2 rounded-full bg-indigo-900"></div>
                </div>
              </td>
              <td class="px-7 2xl:px-0">
                <button
